...
class SaticiGelirleriController extends Controller
{
    /**
    ...
    public function index()
    {
      //  $walletCostsheets = WalletCostsheet::latest()->paginate(10);
        ...
        return view('back.saticiGelirleris.index',  compact('walletCostsheets'));
    }
