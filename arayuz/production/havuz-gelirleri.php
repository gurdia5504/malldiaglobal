          ...
          <div class="container">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <ul class="nav nav-tabs">
                <li class="active">
                  <a data-toggle="tab" href="#tr">TR Havuz</a>
                </li>
                <li><a data-toggle="tab" href="#eu">EU Havuz</a></li>
                <li><a data-toggle="tab" href="#usa">USA Havuz</a></li>
                <li><a data-toggle="tab" href="#asia">Asya Havuz</a></li>
              </ul>
