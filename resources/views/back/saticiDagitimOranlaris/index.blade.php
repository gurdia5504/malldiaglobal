          ...
          $.get(tabUrl, function(data) {
            ...
            <div id="exTab1" class="col-md-12 col-sm-12 col-xs-12">
                <ul class="nav nav-tabs flex-row">
                    <li class="nav-item ">
                        <a class="vav-link {{request()->is('saticiDagitimOranlaris') ? 'active' : null}}"
                            href="{{ url('saticiDagitimOranlaris') }}" data-toggle="saticiDagitimOranlaris">Tümü Havuz
                        </a>
                    </li>
                    &nbsp;&nbsp;&nbsp;
                    ...
                    <li class="nav-item ">
                        <a class="vav-link {{request()->is('saticiDagitimOranlaris-tr_havuz') ? 'active' : null}}"
                            href="{{ url('saticiDagitimOranlaris-tr_havuz') }}" data-toggle="saticiDagitimOranlaris">TR
                            Havuz Dagitim</a>
                    </li>
                    &nbsp;&nbsp;&nbsp;

                    <li class="nav-item ">
                        <a class="vav-link {{request()->is('saticiDagitimOranlaris-ue_havuz') ? 'active' : null}}"
                            href="{{ url('saticiDagitimOranlaris-ue_havuz') }}" data-toggle="saticiDagitimOranlaris">UE
                            Havuz Dagitim</a>
                    </li>
                    &nbsp;&nbsp;&nbsp;

                    <li class="nav-item ">
                        <a class="vav-link {{request()->is('saticiDagitimOranlaris-usa_havuz') ? 'active' : null}}"
                            href="{{ url('saticiDagitimOranlaris-usa_havuz') }}" data-toggle="saticiDagitimOranlaris">USA
                            Havuz Dagitim</a>
                    </li>
                    &nbsp;&nbsp;&nbsp;
                    ...
                    <li class="nav-item ">
                        <a class="vav-link {{request()->is('havuzGelirleris-asya_havuz') ? 'active' : null}}"
                            href="{{ url('saticiDagitimOranlaris-asya_havuz') }}" data-toggle="saticiDagitimOranlaris">ASYA
                            Havuz Dagitim</a>
                    </li>
                </ul>
                ...
                <div class="tab-content clearfix">
                    ...
                    <div class="tab-pane {{request()->is('saticiDagitimOranlaris') ? 'active' : null}}"
                        id="{{ url('saticiDagitimOranlaris') }}">
                        <br>
                        <div class="x_content">
                            <table id="malldia_tr" class="table table-striped table-bordered dt-responsive"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($walletCostsheets as $key => $walletOrderList )
                    ...
                    <div class="tab-pane {{request()->is('saticiDagitimOranlaris-tr_havuz') ? 'active' : null}}"
                        id="{{ url('saticiDagitimOranlaris-tr_havuz') }}">
                        <br>
                        <div class="x_content">
                            <table id="malldia_tr" class="table table-striped table-bordered dt-responsive"
                                style="overflow-x:auto;">
                    ...
                    <div class="tab-pane {{request()->is('saticiDagitimOranlaris-ue_havuz') ? 'active' : null}}"
                        id="{{ url('saticiDagitimOranlaris-ue_havuz') }}">
                        <br>
                    ...
                    <div class="tab-pane {{request()->is('saticiDagitimOranlaris-usa_havuz') ? 'active' : null}}"
                        id="{{ url('saticiDagitimOranlaris-usa_havuz') }}">
                        <br>
                    ...
                    <div class="tab-pane {{request()->is('saticiDagitimOranlaris-asya_havuz') ? 'active' : null}}"
                        id="{{ url('saticiDagitimOranlaris-asya_havuz') }}">
                        <br>
