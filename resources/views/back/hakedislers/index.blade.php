          ...
          $.get(tabUrl, function(data) {
            ...
            <div id="exTab1" class="col-md-12 col-sm-12 col-xs-12">
                <ul class="nav nav-tabs flex-row">
                    <li class="nav-item ">
                        <a class="vav-link {{request()->is('hakedislers') ? 'active' : null}}"
                            href="{{ url('hakedislers') }}" data-toggle="hakedislers">Tümü Havuz Dağıtım
                        </a>
                    </li>
                    &nbsp;&nbsp;&nbsp;
                    ...
                    <li class="nav-item ">
                        <a class="vav-link {{request()->is('hakedislers-tr_havuz') ? 'active' : null}}"
                            href="{{ url('hakedislers-tr_havuz') }}" data-toggle="hakedislers">TR
                            Havuz Dağıtım</a>
                    </li>
                    &nbsp;&nbsp;&nbsp;

                    <li class="nav-item ">
                        <a class="vav-link {{request()->is('hakedislers-ue_havuz') ? 'active' : null}}"
                            href="{{ url('hakedislers-ue_havuz') }}" data-toggle="hakedislers">UE
                            Havuz Dağıtım</a>
                    </li>
                    &nbsp;&nbsp;&nbsp;

                    <li class="nav-item ">
                        <a class="vav-link {{request()->is('hakedislers-usa_havuz') ? 'active' : null}}"
                            href="{{ url('hakedislers-usa_havuz') }}" data-toggle="hakedislers">USA
                            Havuz Dağıtım</a>
                    </li>
                    &nbsp;&nbsp;&nbsp;

                    <li class="nav-item ">
                        <a class="vav-link {{request()->is('hakedislers-asya_havuz') ? 'active' : null}}"
                            href="{{ url('hakedislers-asya_havuz') }}" data-toggle="hakedislers">ASYA
                            Havuz Dağıtım</a>
                    </li>
                </ul>
                ...
                <div class="tab-content clearfix">
                    ...
                    <div class="tab-pane {{request()->is('hakedislers') ? 'active' : null}}"
                        id="{{ url('hakedislers') }}">
                        <br>
                        <div class="x_content">
                    ...
                    <div class="tab-pane {{request()->is('hakedislers-tr_havuz') ? 'active' : null}}"
                        id="{{ url('hakedislers-tr_havuz') }}">
                        <br>
                        <div class="x_content">
                            <table id="malldia_tr" class="table table-striped table-bordered dt-responsive"
                                style="width: 100%">
                    ...
                    <div class="tab-pane {{request()->is('hakedislers-ue_havuz') ? 'active' : null}}"
                        id="{{ url('hakedislers-ue_havuz') }}">
                        <br>
                    ...
                    <div class="tab-pane {{request()->is('hakedislers-usa_havuz') ? 'active' : null}}"
                        id="{{ url('hakedislers-usa_havuz') }}">
                        <br>
                    ...
                    <div class="tab-pane {{request()->is('hakedislers-asya_havuz') ? 'active' : null}}"
                        id="{{ url('hakedislers-asya_havuz') }}">
                        <br>
