...
<body>
    ...
    <div class="row">
        <div class="col-md-2">
            <input style="border-radius: 5px" type="text" class="form-control" placeholder="Cüzdan Satıcısı">
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-2">
            <input style="border-radius: 5px" type="text" class="form-control" placeholder="Ülke ID">
        </div>
