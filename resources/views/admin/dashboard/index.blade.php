    ...
    <body class="nav-md">
        <div class=" body">
            <div class="main_container">
                ...
                <!-- page content -->
                <div class="right_col" role="main" style="min-height: 916px;">
                    <!-- page content -->
                    <div class="row">
                    ...
                    ">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ asset('assets/images/' . $user['image_path']) }}"
                                                        class="rounded-circle img-fluid" style="width: 60px;" alt="Avatar"
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="x_panel">
                                            <div class="price-card">
                                                <h3>
                                                    <i class="fa-solid fa-wallet fa-beat fa-2xl" style="color: #bb2782"></i>
                                                </h3>
                                                ...
                                                <input class="btn btn-success" placeholder="2.000 TL: " type="text">
                                    ...
                                    <div class="card p-4 col-sm-6 row-lg-12">
                                        ...
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" id="home-tab" data-toggle="tab"
                                                    ...
                                                    aria-controls="home" aria-selected="true">Bekleyen Transferim</button>
                                            </li>
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" id="profile-tab" data-toggle="tab"
                                                    ...
                                                    aria-controls="profile" aria-selected="false">Gelen
                                                    Transferim</button>
                                            </li>
